...
import { _ as _objectWithoutProperties } from '../_chunks/dep-a2cd0a21.mjs';
...
import { _ as _slicedToArray } from '../_chunks/dep-d5984b98.mjs';
...
import { u as usePrefixClass, e as useDisabled, n as useReadonly, a as useTNodeJSX, k as useDefaultValue, j as useVModel } from '../_chunks/dep-c69e7150.mjs';
    ...
    var renderValueDisplay = function renderValueDisplay() {
      var renderTag = function renderTag() {
        ...
        return (_innerValue$value$sli = (_innerValue$value$sli2 = innerValue.value.slice(0, props2.minCollapsedNum ? props2.minCollapsedNum : innerValue.value.length)).map) === null || _innerValue$value$sli === void 0 ? void 0 : _innerValue$value$sli.call(_innerValue$value$sli2, function (v, key) {
          var _option$label;
          var tagIndex;
          var option = currentSelectOptions.value.find(function (item, index) {
            if (item.value === v) {
              tagIndex = index;
              return true;
            }
          ...
          return createVNode(Tag, mergeProps({
            "key": key,
            "closable": !(option !== null && option !== void 0 && option.disabled) && !props2.disabled && !props2.readonly,
            "size": props2.size
          }, props2.tagProps, {
